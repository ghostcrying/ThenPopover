...
open class ThenPopoverTransition: NSObject {
    public var options: TransitionOptions

    public init(options: TransitionOptions = .normal(duration: 0.25)) {
    ...
    ///
    /// - Parameter transitionContext: The context with everything needed for the animiation.
    open func afterAnimation(using _: TransitionContext) {}
}

// MARK: - UIViewControllerAnimatedTransitioning

extension ThenPopoverTransition: UIViewControllerAnimatedTransitioning {
    ...
    public func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let presentrContext = TransitionContext(
        ...
        case let .normal(duration):
            animate(
                presentrContext: presentrContext,
...
extension ThenPopoverTransition {
    private func animate(presentrContext: TransitionContext, transitionContext: UIViewControllerContextTransitioning, duration: TimeInterval) {
    ...
    private func animateWithSpring(presentrContext: TransitionContext, transitionContext: UIViewControllerContextTransitioning, duration: TimeInterval, delay: TimeInterval, damping: CGFloat, velocity: CGFloat) {
        beforeAnimation(using: presentrContext)
        UIView.animate(
